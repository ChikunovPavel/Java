package unitTest.GB.seminar1.seminars.first;

import unitTest.GB.seminar1.seminars.first.model.Hero;
...
//        testingJavaCollectionsAssertJ(colors);
    ...
    public static void assertConditionB() {
        int x = -1;
        assert x <= 0 : "Заданное значение больше чем int";
    }
    ...
    public static int sum(int a, int b) {
        assert  2147483647 - a >= b: "Заданное значение больше чем int" ;
        return a + b;
    }
    ...
    String[] colors = {"gold", "orange", "green", "violet","yellow", "blue","aqua"};
    /**
...
//    Hero emmett = new Hero("Emmett", 50, "sword", heroBag, true);
    public static void checkingHero(Hero hero) {
        ...
        assertThat(hero.getName()).hasSize(6);
