...
//3. Router (навигация):
//
//        Router управляет переходами между экранами. Он может взаимодействовать с навигационной системой приложения, чтобы показать новый экран или вернуться назад.
...
//
//        Builder ответственен за создание и связывание всех компонентов RIBs. Он инкапсулирует процесс создания экземпляров и инъекции зависимостей.
