...
*/
    ...
    void priceCartIsCorrectCalculated() {
        ...
        assertThat(cart.getTotalPrice()).isEqualTo(170+250+150);
    ...
    void whenChangingCartCostRecalculationIsCalled() {
        ...
        assertThat(cart.getTotalPrice()).isEqualTo(cart.getProductByProductID(2).getPrice() + cart.getProductByProductID(3).getPrice());
